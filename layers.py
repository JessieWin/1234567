...
class LeakyReluLayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        return 0.01 * inputs *( inputs <= 0) + inputs * (inputs > 0)
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        return (0.01 * (inputs <= 0) + 1 * (inputs>0)) * grads_wrt_outputs
...
class ELULayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        return 1 * (np.exp(inputs)-1) * (inputs<=0) + inputs * (inputs>0)
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        return (1 * np.exp(inputs) * (inputs <= 0) + 1 * (inputs > 0)) * grads_wrt_outputs
...
class SELULayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        return 1.6733 * 1.0507*(np.exp(inputs)-1)*(inputs<=0)+inputs* 1.0507*(inputs>0)
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        return (1.0507*1.6733*np.exp(inputs)*(inputs<=0)+1.0507*1*(inputs>0))*grads_wrt_outputs
